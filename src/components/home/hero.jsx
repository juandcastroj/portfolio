        ...
        <div className="mx-auto max-w-4xl lg:mx-0 lg:flex gap-12 lg:max-w-none">
          <div className="flex flex-col justify-between">
              ...
              <div className="my-2 sm:my-8 max-w-xl lg:mt-0 xl:col-end-1 xl:row-start-1">
                <p className="text-base sm:text-lg md:text-xl lg:mt-6 font-normal text-gray-500 dark:text-gray-200">
                    Focused on frontend, with a full-stack mindset.
                    I enjoy learning and sharing knowledge, 
                    and I’m passionate about technology, music, running and cycling.
