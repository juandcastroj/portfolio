...
export default function Hero() {
  ...
  return (
    <div className="min-h-[75vh] sm:min-h-screen flex items-center relative isolate -z-10 overflow-hidden pt-14 animate-fade-down animate-duration-[3000ms] animate-delay-800">
      <div className="mx-auto max-w-5xl p-10 sm:py-28 lg:py-36 lg:px-8">
        <div className="mx-auto max-w-4xl lg:mx-0 sm:flex gap-12 lg:max-w-none">
          <div className="flex flex-col justify-between text-center sm:text-left">
              ...
              <div className="my-2 sm:my-8 max-w-xl lg:mt-0 xl:col-end-1 xl:row-start-1">
                <p className="text-base md:text-xl lg:mt-6 font-normal text-gray-500 dark:text-gray-200">
                    Specialized on frontend, with a full-stack mindset.
          ...
          <img
              alt="JD photo"
              src={JD_photoDark}
              className="hidden dark:block aspect-square mx-auto mt-12 sm:mt-8 md:mt-0 w-full rounded-full object-cover max-w-56 lg:max-w-72 text-center"
            />
          <img
              alt="JD photo"
              src={JD_photoLight}
              className="dark:hidden aspect-square mx-auto mt-12 sm:mt-8 md:mt-0 w-full rounded-full object-cover max-w-56 lg:max-w-72 text-center"
            /> 
        </div>
      </div>
    </div>
