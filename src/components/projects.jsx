    ...
    <div className="py-20 md:py-28">
      <div className="mx-auto max-w-7xl gap-20 px-6 lg:px-8 font-mono">
        ...
        <ul role="list" className="-mt-12 space-y-12 divide-y divide-gray-200 xl:col-span-3">
          ...
          {  projectsData.map( ({ company, role, imageUrl, description, url, repo }, index) => (
                ...
                <li key={index} className="flex flex-col gap-10 pt-12 sm:flex-row">
                  ...
                  <img alt={company} src={imageUrl} className="aspect-auto w-[24rem] md:w-96 xl:w-[35rem] h-72 flex-none rounded-none md:rounded-2xl" />

                  <div className="max-w-xl flex-auto animate-fade-left">
                    <a href={url} target="_blank" rel="noopener noreferrer">  
                      <h3 className="text-xl font-semibold tracking-tight text-green-900 dark:text-blue-300">{company}</h3>
                      <p className="text-base/7 font-semibold text-gray-600 dark:text-gray-200">{role}</p>
                      <p className="mt-1 text-base/7 text-gray-600 dark:text-gray-200">{description}</p>
                    </a>


                    <a href={repo} className="text-gray-600 hover:text-gray-500 dark:text-gray-200">
                      <span className="sr-only">Repository</span>
                      <svg fill="currentColor" viewBox="0 0 30 30" aria-hidden="true" className="mt-4 size-10">
                        <path
