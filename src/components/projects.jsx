...
const { company, role, imageUrl, description, url, github } = projectsData
        ...
        <ul role="list" className="-mt-12 space-y-12 divide-y divide-gray-200 xl:col-span-3">
          {
            projectsData.map((project, index) => (
                ...
                <li key={index} className="flex flex-col gap-10 pt-12 sm:flex-row">
                  ...
                  <img alt={project.company} src={project.imageUrl} className="aspect-square w-[24rem] md:w-96 xl:w-[35rem] h-72 flex-none rounded-none md:rounded-2xl" />

                  <div className="max-w-xl flex-auto animate-fade-left">
                    <a href={project.url} target="_blank" rel="noopener noreferrer">  
                      <h3 className="text-xl font-semibold tracking-tight text-green-900 dark:text-blue-300">{project.company}</h3>
