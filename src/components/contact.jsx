      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
          ...
          <div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
            ...
            <dl className="mt-10 space-y-4 text-base/7 text-gray-600">
              ...
              <div className="flex gap-x-4">
                ...
                <dd>
                  <a href="tel:+57 320 484 6725" className="hover:text-gray-900">
                    +57 320 484 6725
                  </a>
                </dd>
              </div>
              <div className="flex gap-x-4">
                ...
                <dd>
                  <a href="mailto:juandavid4130@gmail.com" className="hover:text-gray-900">
        ...
        <form action="#" method="POST" className="px-6 pb-24 pt-20 sm:pb-32 lg:px-8 lg:py-48">
          <div className="mx-auto max-w-xl lg:mr-0 lg:max-w-lg">
            ...
            //                 </dt>
            //                 <dd>
            //                 <a href="tel:+57 320 484 6725" className="hover:text-white">
            //                     +57 320 484 6725
            //                 </a>
            //                 </dd>
            //             </div>
            ...
            //                 </dt>
            //                 <dd>
            //                 <a href="mailto:juandavid4130@gmail.com" className="hover:text-white">
            //                     juandavid4130@gmail.com
            //                 </a>
            //                 </dd>
            //             </div>
