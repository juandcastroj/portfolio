...
export function Navbar( navigationItems, handleMobileMenu ) {
...
//   }, [lastScrollY]);
  ...
  return (
    <>    
        {/* <div
            className={clsx(
            "fixed top-0 w-full bg-blue-300 p-4 text-center transition-transform duration-300",
            {
