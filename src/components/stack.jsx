      ...
      <div id="Stack" className="py-16 sm:py-20">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:mx-0">
            <h2 className="text-pretty text-4xl font-semibold tracking-tight text-green-900 dark:text-fuchsia-500 sm:text-5xl">My stack</h2>
          ...
          >
            ...
            {people.map((tech) => (
              <li key={tech.name}>
                ...
                <h3 className="mt-6 text-base/7 font-semibold tracking-tight text-green-900 dark:text-fuchsia-500">{tech.name}</h3>
